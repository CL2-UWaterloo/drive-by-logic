...
def visit_all(planner, final, t_max):
    goal_signals = []
    for goal in final:
        reach_signals = []
    ...
    planner.set_constraint("robustness", planner.cost, lbg=0.25, ubg=4.0)
    planner.cost *= -1
...
if __name__ == "__main__":
    ...
    solution, solver = plan(visit_all, init, final, obstacles, pf, 170, 10, 50, 1)
