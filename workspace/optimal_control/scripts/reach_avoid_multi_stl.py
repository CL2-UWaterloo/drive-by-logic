...
def reach_avoid(all_signals : list[list[Waypoint]], finals, finish_by, obstacles):
    ...
    for signals in all_signals:
        ...
        agent_task_signals.extend(goal_signals)
        agent_task_signals.extend(obstacle_signals)
...
if __name__ == "__main__":
    ...
    cfhandle.problem.set_equality_constraint("robust_bool", robustness, MARGIN)
