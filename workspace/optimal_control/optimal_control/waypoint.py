...
class DubinWaypoint:
    ...
    @staticmethod
    def from_list(value):
        ret = SmoothWaypoint(X=DM(vertcat(value[0:3])), U=DM(vertcat(value[3:5])), t=DM(value[6]))
        return ret
...
class SmoothWaypoint:
    ...
    @staticmethod
    def from_list(value):
        ret = SmoothWaypoint(X=DM(vertcat(value[0:6])), U=DM(vertcat(value[6:8])), t=DM(value[8]))
        return ret